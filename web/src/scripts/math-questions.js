const showData = data => {
  for (let index = 0; index < data.length; index++) {
    ...
    if (index < 1) {
      ...
      p.innerHTML =
        'Aqui estão disponibilizadas algumas questões de matemática para colocar o seu conhecimento em prática, e não se esqueça é de extrema importância rever o conteúdo após um certo tempo. Bons estudos!'
...
function showResponse() {
  fetch('https://api-estudandocomquestoes.up.railway.app/matematica')
    .then(response => {
